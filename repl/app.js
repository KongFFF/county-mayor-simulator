        ...
        this.#life.config({
            ...
            propertyConfig: {
                ...
                judge: {
                    ...
                    HMNY: [ // 财政
                        [-100, 0, 'UI_Judge_Level_0'],
                        [5, 0, 'UI_Judge_Level_1'],
                        [10, 0, 'UI_Judge_Level_2'],
                        [20, 0, 'UI_Judge_Level_3'],
                        [30, 1, 'UI_Judge_Level_4'],
                        [40, 2, 'UI_Judge_Level_5'],
                        [50, 3, 'UI_Judge_Level_6'],
                    ],
                    HSPR: [//稳定度
                        [-100, 0, 'UI_Spirit_Judge_Level_0'],
                        [1, 0, 'UI_Spirit_Judge_Level_1'],
                        [3, 0, 'UI_Spirit_Judge_Level_2'],
                        [5, 0, 'UI_Spirit_Judge_Level_3'],
                        [10, 1, 'UI_Spirit_Judge_Level_4'],
                        [15, 2, 'UI_Spirit_Judge_Level_5'],
                        [20, 3, 'UI_Spirit_Judge_Level_6'],
                    ],
                    HINT: [//环境
                        [-100, 0, 'UI_Judge_Level_0'],
                        [1, 0, 'UI_Judge_Level_1'],
                        [2, 0, 'UI_Judge_Level_2'],
                        [5, 0, 'UI_Judge_Level_3'],
                        [10, 1, 'UI_Judge_Level_4'],
                        [15, 2, 'UI_Judge_Level_5'],
                        [30, 3, 'UI_Judge_Level_6'],
                        [40, 3, 'UI_Intelligence_Judge_Level_7'],
                        [50, 3, 'UI_Intelligence_Judge_Level_8'],
                        [60, 3, 'UI_Intelligence_Judge_Level_9'],
                    ],
                    HSTR: [//人口
                        [-100, 0, 'UI_Judge_Level_0'],
                        [1, 0, 'UI_Judge_Level_1'],
                        ...
                        [4, 0, 'UI_Judge_Level_3'],
                        [7, 1, 'UI_Judge_Level_4'],
                        [10, 2, 'UI_Judge_Level_5'],
                        [20, 3, 'UI_Judge_Level_6'],
                        [30, 3, 'UI_Strength_Judge_Level_7'],
                        [35, 3, 'UI_Strength_Judge_Level_8'],
                        [40, 3, 'UI_Strength_Judge_Level_9'],
                        [45, 3, 'UI_Strength_Judge_Level_10'],
                        [50, 3, 'UI_Strength_Judge_Level_11'],
                    ],
                    HAGE: [//任期
                    ...
                    SUM: [
                        ...
                        [30, 1, 'UI_Judge_Level_4'],
                        [40, 2, 'UI_Judge_Level_5'],
                        [45, 3, 'UI_Judge_Level_6'],
                        [50, 3, 'UI_Judge_Level_7'],
                    ],
                },
            },
            characterConfig: {
